...
var (
	// UserOrderFieldPriority orders User by priority.
	UserOrderFieldPriority = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.Priority, nil
		},
		column: user.FieldPriority,
		toTerm: user.ByPriority,
...
func (f UserOrderField) String() string {
	var str string
	switch f.column {
	case UserOrderFieldPriority.column:
		str = "priority"
	}
	return str
}
